...
class TransformerModelBase(FairseqEncoderDecoderModel):
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        encoder = TransformerEncoderBase(cfg, src_dict, embed_tokens)
        ## 如果encoder存在预先训练好的需要加载的参数的话，加载参数
        model_path = cfg.pretrained_encoder_model_path
    ...
    def forward(
        ...
        """
        if self.cfg.pretrained_encoder_model_path is not None:
            #冻结加载进来的模块的参数
