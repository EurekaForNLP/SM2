...
def _main(cfg: DictConfig, output_file):
    ...
    for sample in progress:
        ...
        if cfg.generation.teacher_force:
        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            ...
            # out_max = finalized_recording["max"]
            # out_var = finalized_recording["var"]
            # out_entropy = finalized_recording["entropy"]
            # out_prob["max"].append(out_max)
            # out_prob["var"].append(out_var)
            # out_prob["entropy"].append(out_entropy)
            ...
            for j, hypo in enumerate(hypos[i][: cfg.generation.nbest]):
                ...
                if not cfg.common_eval.quiet:
                    ...
                    # print("OP-{}\tMax:{}\tVar:{}:\tEntropy:{}".format(
                    #         sample_id,out_max,out_var,out_entropy
                    # ),file = output_file
                    # )
                    print(
                        "P-{}\t{}".format(
    ...
    # print("Out_prob :\nMax:{}\nVar:{}\nEntropy:{}".format(np.mean(out_prob["max"]),np.mean(out_prob["var"]),np.mean(out_prob["entropy"])))
    ...
    if cfg.generation.teacher_force:
        print("average faithfulness score:{}".format(sum(score_list)/len(score_list)))
    return scorer
