...
@dataclass
class TransformerWithSM2Config(FairseqDataclass):
    ...
    share_encoder_decoder_embeddings: bool = field(
        default=False,
        metadata={
            "help": "share encoder, decoder and output embeddings (requires shared dictionary and embed dim)"
        },
    ...
    ## added paramter for SM2
    min_prefix_src_len:int = field(
        default= 1, metadata={"help":"use wait k to train the unidirectional model"}
    )
